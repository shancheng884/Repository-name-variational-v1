...
from tools.simulate_inventory_strategy import read_samples, simulate_long_inventory


def _sample(ts: str, var_buy: str, var_sell: str, lighter_bid: str, lighter_ask: str) -> dict:
    edge = (Decimal(lighter_bid) - Decimal(var_buy)) / Decimal(var_buy) * Decimal("10000")
    return {
        "event": "market_sample",
        "logged_at": ts,
        "asset": "BTC",
        ...
        "long_var_short_lighter_bps": str(edge),
    }
